...
<!-- 			<tr align="center" style="height: 200px;">
	...
	<div >
		<center>
			...
			<a  href="editprofile.php" name="editprofile" style="font-size: 20px;">Edit Profile</a>| 
			|<a href="change_pass.php" name="changepassword" style="font-size: 20px;">Change Password</a>
		</center><br><br>
	</div>
<?php
}
